...
// Note that in a real world usage, the acche duration shouldn't have
...
// Initailizing the store service and return a store pointer
func InitializeStore() *StorageService {
	...
	if err != nil {
		panic(fmt.Sprintf("Errorr init Redis: %v", err))
	}
...
is provided. This is when users will be calling the shortlink in the url,
so what we need to do here is to retrieve the long url and think
about redirect
 */
